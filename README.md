...
graph TD
    ...
    B --> C[Randomized Scenario Assessment: 6 Decision Dilemmas]
    C --> D[Reflex Latency & Reaction Speed Tracker]
    D --> E{Optional Biometric Scan?}
    E -- Yes --> F[5-sec Optical Motion Analysis]
    E -- No --> G[Direct Result Calculation]
    F --> G
    G --> H[Shannon Entropy & Cosine Similarity Clustering Engine]
    H --> I[Plain-English Result Modal & Archetype Assignment]
